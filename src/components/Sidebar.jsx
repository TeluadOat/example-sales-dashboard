import { FaChartPie, FaTrophy, FaShoppingCart, FaBoxOpen, FaFileAlt, FaEnvelope, FaCog, FaSignOutAlt } from "react-icons/fa";
...
export default function Sidebar({ active }) {
  ...
  return (
    <div className="w-64 h-screen bg-white p-4 flex flex-col justify-between shadow-lg">
      <div>
        <h1 className="text-xl font-bold mb-8">Dabang</h1>
        {menu.map((item) => (
          <div
            key={item.name}
